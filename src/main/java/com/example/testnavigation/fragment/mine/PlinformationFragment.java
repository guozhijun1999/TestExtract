 ...
 */
public class PlinformationFragment extends BaseFragment<UserListComment.ListCommentV, IPUserListComment<UserListComment.ListCommentV>> implements UserListComment.ListCommentV {
    ...
    public PlinformationFragment() {
        // Required empty public constructor
    }

    @Override
    protected int createLayoutId() {
        return R.layout.fragment_plinformation;
    }
    ...
    public void showListCommentTab(UserListCommentBean userListCommentBean) {
        for (int i = 0; i < userListCommentBean.getUserCommentList().size(); i++) {
            if (userListCommentBean.getUserCommentList().get(i).getObjectType().equals("0")) {
