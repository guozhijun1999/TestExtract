...
public class AttentionDao extends AbstractDao<Attention, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Boo = new Property(1, boolean.class, "boo", false, "BOO");
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Attention entity) {
        ...
        stmt.bindLong(2, entity.getBoo() ? 1L: 0L);
    }
    ...
    public Attention readEntity(Cursor cursor, int offset) {
        Attention entity = new Attention( //
            ...
            cursor.getShort(offset + 1) != 0 // boo
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Attention entity, int offset) {
        ...
        entity.setBoo(cursor.getShort(offset + 1) != 0);
     }
